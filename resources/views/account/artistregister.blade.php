...
{{-- register --}}
<div class="py-10 bg-cover bg-center bg-no-repeat" style="background-image: url('https://images.pexels.com/photos/1266808/pexels-photo-1266808.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')">
                ...
                <div class="flex">
                    ...
                    <div class="w-1/2 p-4">
                        ...
                        <p class="text-gray-500 mt-1 ml-3 text-xs font-extralight text-gray-200">
                            Note: Please upload the required documents for verification based on your Artist type.
                        </p>
