            ...
            <div class="w-full max-w-xl mx-auto relative flex">
                ...
                {{-- <div class="flex items-center justify-between flex-grow py-3 pl-96 ml-10"> --}}
                    <div class="flex items-center space-x-6 capitalize ml-10">
                        ...
                        <a href="" class="text-gray-100 hover:underline hover:text-red-500 hover:scale-105 transition">Inquiries</a>
                        <a href="" class="text-gray-100 hover:underline hover:text-red-500 pl-12 hover:scale-105 transition">Contracts</a>
